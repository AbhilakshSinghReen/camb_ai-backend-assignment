...
class TestAPIs(unittest.TestCase):
    ...
    def test_add_key_value_pair(self):
        ...
        assert add_response_data.get('result', {}).get('message', None) == "Addition scheduled."
    ...
    def test_update_key_value_pair(self):
        ...
        assert update_response_data.get('result', {}).get('message', None) == "Updation scheduled."
    ...
    def test_delete_key_value_pair(self):
        ...
        assert delete_response_data.get('success', None) == True
        assert delete_response_data.get('result', {}).get('message', None) == "Deletion scheduled."
    ...
    #     assert add_response_data.get('error', {}).get('message', None) == "Key already exists"
